...
<?php
  ...
  $paragraph = "Graduated from the University of Toronto Electrical and Computer Engineering program in 2019. Worked as a Tech Mahindra employee from October 2021 to March 2023. Worked on a Scotiabank Pega project as a TechM contractor from August 2022 to January 2023. Passionate about PEGA, software design, web development, computer networks and system design. Adept in PEGA PRPC, Java, Python, HTML, CSS, JavaScript, and PostgreSQL, with working knowledge of a number of other programming languages. Experienced with object-oriented programming, relational database logic, design and querying, and network programming and protocols. Strong work ethic both individually and as a team member. Quick to learn and adapt existing knowledge to new technologies, applications and programming languages. Canadian Citizen.";
